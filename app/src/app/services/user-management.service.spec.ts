...
describe('UserManagementService', () => {
  ...
  it('queries paged accounts with filters', () => {
    ...
    const req = http.expectOne(request =>
      request.url === 'http://localhost:5130/api/admin/users' &&
  ...
  it('calls account mutation endpoints', () => {
    ...
    const create = http.expectOne('http://localhost:5130/api/admin/users');
    ...
    const role = http.expectOne('http://localhost:5130/api/admin/users/user-1/role');
    ...
    const status = http.expectOne('http://localhost:5130/api/admin/users/user-1/status');
    ...
    const deleteRequest = http.expectOne('http://localhost:5130/api/admin/users/user-1');
