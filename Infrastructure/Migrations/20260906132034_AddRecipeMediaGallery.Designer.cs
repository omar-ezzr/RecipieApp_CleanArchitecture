...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260906132034_AddRecipeMediaGallery")]
    partial class AddRecipeMediaGallery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.Cuisine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Domain.Entities.RecipeMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Recipie", b =>
                {
                    ...
                    b.Property<string>("ServingOccasion")
                        .HasMaxLength(200)
                    ...
                    b.HasIndex("CuisineId", "CreatedAt");

                    b.HasIndex("RegionId", "CreatedAt");

                    b.HasIndex("UserId", "CreatedAt");

                    b.HasIndex("CuisineId", "RegionId", "CreatedAt");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Recipie", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.Cuisine", "Cuisine")
                        .WithMany("Recipes")
